...
gulp.task("watch", function () {
  ...
  gulp.watch(
    ["./src/**/*.html", "./src/*.html"],
    gulp.series("html", "clearCache", "reload")
  );
  gulp.watch(
    "./src/js/**/*.js",
    gulp.series("scripts", "clearCache", "reload")
  );
...
gulp.task(
  "export",
  gulp.parallel("scss", "css", "html", "scripts", "images", "documents")
);
